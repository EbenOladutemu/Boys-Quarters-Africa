  ...
  metaInfo(){
    return{
      meta: [
        ...
        { name: 'image', content: this.siteImage },
        ...
        { itemprop: 'image', content: this.siteImage },
        ...
        { property: 'og:image', content: this.siteImage },
        ...
        { name: 'twitter:site', content:  '@boysqafrica' },
