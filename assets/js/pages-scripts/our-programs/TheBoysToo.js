Vue.component('header-boys-too',{
	template: `<header class="masthead masthead-boys-too article overlay-header">
      <div class="container">
...
Vue.component('boys-too',{
  template: `<section class="bg-light" style="padding-top: 50px; padding-bottom: 50px">
      <div class="container">
        <div class="row">
