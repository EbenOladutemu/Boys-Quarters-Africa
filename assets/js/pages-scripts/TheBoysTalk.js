Vue.component('header-boys-talk',{
	template: `<header class="masthead masthead-boys-talk article overlay-header">
      <div class="container">
...
Vue.component('the-boys-talk',{
  template: `<section>
    <div class="container">
      <div class="col-lg-12 text-center">
        <h2 class="section-heading text-uppercase">The Boys Talk</h2><br>
      </div>
