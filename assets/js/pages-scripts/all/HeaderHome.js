	...
	template: `<header class="masthead article overlay-header">
      <div class="container">
        <div class="intro-text">
          ...
          <div class="intro-lead-in d-none d-sm-block d-sm-none d-md-block d-md-none d-lg-block pad-lg-font-lg intro-mg text-uppercase text-bold">We’ve been commissioned to educate, empower & advocate for a new tribe of Boys
