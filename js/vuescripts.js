                      ...
                      <div class="timeline-panel">
                        ...
                        <div class="timeline-body">
                          <p>After reading the Dignity of Manhood by Gbile Akanni for the second time in 2014, the passion to see young boys live out the fullness of destiny became a tingling and subtle burden. The book re-opened my heart to the gap in the boy-child space and need for MEN to stand in their place in Destiny. However, I have in my personal space reached out to a couple of young boys, encouraged them and challenged them on divergent front through one-on-one mentorship and other religious platforms.
                            ...
                            The Book, the several lamentations and the current realties has resonated to a call to action.<br></span></p>
       ...
       new Vue ({el: '#about-component'})


       Vue.component ('creed-modal',
       {
        template: `
       ...
       new Vue ({el: '#creed-modal-component'})
                ...
                <div class="col-sm-4">
                  <div class="team-member">
                    ...
                    <li class="list-inline-item bg-facebook">
                      <a href="https://m.facebook.com/sjayo">
                        <i class="fab fa-facebook-f"></i>
                      </a>
                    </li>
                    <li class="list-inline-item">
                      <a href="https://www.instagram.com/jeddy_solomon/" class="bg-instagram">
                        <i class="fab fa-instagram"></i>
                      </a>
                    </li>
                    <li class="list-inline-item bg-twitter">
                      <a href="https://twitter.com/ayodelesolomon4">
              ...
              <div class="row">
                ...
                <div class="col-sm-4">
                  <div class="team-member">
                    ...
                    <li class="list-inline-item">
                      <a href="https://www.instagram.com/glory_odikagbue" class="bg-instagram">
                        <i class="fab fa-instagram"></i>
                      </a>
                    </li>
                    <li class="list-inline-item bg-twitter">
                      <a href="https://twitter.com/gee_odiks">
                        <i class="fab fa-twitter"></i>
                      </a>
                    </li>
                  </ul> 
